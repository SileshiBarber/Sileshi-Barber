...
export function StatusBanner() {
  ...
  return (
    <div
      id="status-banner"
      className="fixed top-[57px] md:top-[65px] left-0 right-0 z-40 bg-[#0B0C10] border-b border-[#C5A059]/20"
    >
      <div className="container mx-auto px-4 md:px-6 py-2 flex flex-col sm:flex-row items-center justify-between gap-1 sm:gap-4 text-xs">
        <div className="flex items-center gap-4 text-[#C5C6C7]">
        ...
        <div
          id="live-status"
          className="flex items-center gap-2 font-semibold tracking-wider uppercase"
        >
          <span
          ...
          />
          <span
            className={status.isOpen ? "text-emerald-400" : "text-rose-400"}
          >
            {status.label}
          </span>
        </div>
